...
namespace whip
{
	...
	void Settings::reload()
	{
		...
		desc.add_options()
			...
			("cache_enabled", po::value<bool>()->default_value(false), "Enable memory cache")
			("cache_size", po::value<unsigned int>()->default_value(10), "Maximum size of the asset cache in MB")
